...
from .util import ResBlock, conv, deconv, crop_like

__all__ = [
    'CBAfusionnet', 'CBAfusionnet_bn'
]
...
class CBAfusionNet(nn.Module):
    ...
    def forward(self, input_image, target_fusion=None, target_Gmap=None):
        ...
        out_conv03b = temp_result + mask * self.conv03b(out_conv02b)
